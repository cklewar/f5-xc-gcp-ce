...
variable "machine_image_name" {
  type    = string
  default = "rhel9-20230922033926-single-voltmesh-us" #centos7-atomic-20220721105-single-voltmesh-custom"
}
...
variable "machine_image_base" {
  ...
  default = {
    ingress_gateway        = "rhel9-20230922033926-single-voltmesh-us" #"centos7-atomic-20220721105-single-voltmesh-us"
    ingress_egress_gateway = "rhel9-20230922033926-multi-voltmesh-us" #centos7-atomic-20220721105-multi-voltmesh-us"
  }
}
